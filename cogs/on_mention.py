...
class OnMention(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if (self.bot.user.mentioned_in(message) and 
            ...
            try:
                embed = discord.Embed(
                    title="<:UA_Rocket_icons:1447124128342478990> Hey there! Thanks for mentioning me!",
                    description=f"<:welcome:1447124320286674997> **Welcome to the {self.bot.user.name} Support System!**\n\n<:icons_heart:1447124283519271105> I'm here to help you create and manage support tickets efficiently.\n\n<:j_icons_Correct:1447124105311682673> **Quick Start:**\n• Use `{self.config.PREFIX}help` for command list\n• Use `/help` for slash commands\n• Set up with `{self.config.PREFIX}setup-tickets`\n\n<:people_icons:1447124377551507629> Need assistance? Join our support server below!",
                    color=0x000000
                )
                ...
                embed.add_field(
                    name="<:Ticket_icons:1447124189650878464> **Quick Commands**",
                ...
                embed.add_field(
                    name="<:stats_1:1447124183686320259> **Useful Links**",
                    value=f"<:Icons_link:1447124330034102416> **[Support Server]({self.config.SUPPORT_SERVER})**\n<:icons_wrench:1447124178296766494> **[Setup Guide](https://discord.gg/renderbyte)**",
                    inline=True
                )
                
                embed.set_footer(
                    text=f"Powered by Renderbyte™ • Prefix: {self.config.PREFIX}",
