...
class GlobalErrorHandler(commands.Cog):
    ...
    def create_error_embed(self, title: str, description: str, error_type: str = "general") -> discord.Embed:
        ...
        error_configs = {
            "permission": {
                "color": 0xFF6B6B,
                "emoji": "<:icons_locked:1447124150513696830>"
            },
            "bot_permission": {
                "color": 0xFF6B6B, 
                "emoji": "<:robot:1447124156234858587>"
            },
            "cooldown": {
                "color": 0xFF8C00,
            ...
            "not_found": {
                "color": 0xFF6B6B,
                "emoji": "<:icons_Wrong:1447124112030826516>"
            },
            "validation": {
                "color": 0xFF8C00,
                "emoji": "<:warning:1447124116816793652>"
            },
            "database": {
                "color": 0xFF0000,
                "emoji": "<:disk_icons:1447139222820753480>"
            },
            "network": {
                "color": 0xFF4444,
                "emoji": "<:icons_refresh:1447124123875803136>"
            },
            "general": {
                "color": 0xFF6B6B,
                "emoji": "<:icons_Wrong:1447124112030826516>"
    ...
    async def on_command_error(self, ctx, error):
        ...
        if isinstance(error, commands.MissingPermissions):
            embed = self.create_error_embed(
                ...
                f"<:lightbulb:1447124133107204166> Contact an administrator if you believe this is an error.",
                "permission"
            )
            ...
            embed = self.create_error_embed(
                ...
                f"<:icons_wrench:1447124178296766494> Please ask an administrator to grant me these permissions.",
                "bot_permission"
            )
            ...
            embed = self.create_error_embed(
                ...
                f"<:icons_clock:1447124144348201014> **Try again in:** {error.retry_after:.1f} seconds\n\n"
            ...
            embed = self.create_error_embed(
                ...
                f"<:clipboard1:1447124356130934835> **Usage:** `{ctx.prefix}{ctx.command.qualified_name} {ctx.command.signature}`\n\n"
                f"<:lightbulb:1447124133107204166> Use `{ctx.prefix}help {ctx.command.qualified_name}` for more information.",
                "validation"
            )
            ...
            embed = self.create_error_embed(
                ...
                f"<:shield:1447124194528858143> This is a developer command and cannot be used by regular users.",
                "permission"
            )
            ...
            embed = self.create_error_embed(
                ...
                f"<:warning:1447124116816793652> Please use this command in an appropriate channel.",
                "validation"
            )
            ...
            embed = self.create_error_embed(
                ...
                f"<:icons_wrench:1447124178296766494> Please check my permissions and try again.\n\n"
            ...
            embed = self.create_error_embed(
                ...
                f"<:Target:1447124315211567134> This might be a deleted channel, message, or user.\n\n"
                f"**Details:** {str(error)}",
                "not_found"
            )
            ...
            if "rate limit" in str(error).lower():
                embed = self.create_error_embed(
                    ...
                    f"<:icons_clock:1447124144348201014> Please wait a moment and try again.\n\n"
                ...
                embed = self.create_error_embed(
                    ...
                    f"<:icons_refresh:1447124123875803136> Please try again in a moment.\n\n"
            ...
            embed = self.create_error_embed(
                ...
                f"<:disk_icons:1447139222820753480> Our team has been notified and will fix this soon.\n\n"
                f"<:icons_refresh:1447124123875803136> Please try again in a few minutes.",
                "database"
            )
            ...
            embed = self.create_error_embed(
                ...
                f"<:icons_refresh:1447124123875803136> Please try again. If the issue persists, contact support.\n\n"
            ...
            embed.add_field(
                name="<:clipboard1:1447124356130934835> Error ID",
                value=f"`{error_id}`",
                inline=False
            )
    ...
    async def on_app_command_error(self, interaction: discord.Interaction, error: discord.app_commands.AppCommandError):
        ...
        if isinstance(error, discord.app_commands.MissingPermissions):
            ...
            embed = self.create_error_embed(
                ...
                f"<:icons_Person:1447124205563805698> Contact an administrator to get the required role.",
                "permission"
            )
            ...
            embed = self.create_error_embed(
                ...
                f"<:warning:1447124116816793652> Please check your input and try again.\n\n"
                f"**Error:** {str(error)}",
                "validation"
            )
    ...
    async def handle_view_error(self, interaction: discord.Interaction, error: Exception, error_type: str = "general"):
        ...
        embed = self.create_error_embed(
            ...
            f"<:icons_refresh:1447124123875803136> Please try again or refresh the interface.\n\n"
            f"**Error:** {str(error)[:200]}{'...' if len(str(error)) > 200 else ''}",
            error_type
        )
    ...
    async def handle_database_error(self, ctx, error: Exception):
        ...
        embed = self.create_error_embed(
            ...
            f"<:disk_icons:1447139222820753480> This is usually temporary and resolves quickly.\n\n"
            f"<:icons_refresh:1447124123875803136> Please try again in a moment.",
            "database"
        )
