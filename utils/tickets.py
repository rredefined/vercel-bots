...
async def create_ticket_channel(bot, guild: discord.Guild, user: discord.Member, category_channel, category: str, subject: str, description: str, priority: str) -> Tuple[bool, str]:
    try:
        ...
        embed = discord.Embed(
            title=f"<:Ticket_icons:1447124189650878464> Support Ticket",
        ...
        embed.add_field(
            name="<:clipboard1:1447124356130934835> **Ticket Information**",
        ...
        embed.set_image(url="https://i.imgur.com/XvCOgh2.gif")
        ...
        async with bot.db.cursor() as cur:
            ...
            category_emoji = emoji_result[0] if emoji_result and emoji_result[0] else "<:Ticket_icons:1447124189650878464>"
            ...
            current_time = discord.utils.utcnow()
            embed = discord.Embed(
                title=f"<:Ticket_icons:1447124189650878464> Ticket",
                description=f"**Welcome to your support ticket, {user.mention}!**\n\n"
            ...
            embed.add_field(
                name="<:lightbulb:1447124133107204166> Description",
                value=description[:1000] + "..." if len(description) > 1000 else description,
                inline=False
            )

            embed.add_field(
                name="<:Target:1447124315211567134> Next Steps",
